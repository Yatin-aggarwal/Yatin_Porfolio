...
function Card(props){
    return(
        <>
            <div className={"  text-amber-50  bg-[#0B1224] w-[50%] h-full"}>
                <div
                ...
                <div
                    className=" font-medium  font-mono ml-[10%] w-[80%]  h-[80%]   pl-[2%]  border-2 border-t-[#181A4B]  ">
                    <div className="flex text-md h-[50%] pt-[3%]">
                        {props.content}
                    </div>
                    <div className="flex pl-[2%] h-[45%]  items-end  ">
